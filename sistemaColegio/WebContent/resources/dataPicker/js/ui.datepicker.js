   ...
   allowing multiple different settings on the same page. */
    ...
    function Datepicker() {
        ...
        this.regional[''] = { // Default regional settings
            ...
            'Julio','Agosto','Septiembre','Octubre','Noviember','Diciember'], // Names of months for drop-down and formatting
        ...
        this.dpDiv = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all ui-helper-hidden-accessible" style="z-index: 3"></div>');
    }
