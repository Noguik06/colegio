...
//		var altura =  screen.height * 0.51
		var h = $("#escribirCorreo").outerHeight();
		self.workzone.add(self.iframe).add(self.source).height(h*68.6/100);
	}
...
elRTE.prototype.options   = {
	...
	toolbars    : {
		tiny     : ['style'],
		mine     : ['formatmine', 'stylemine', 'alignment', 'colors'],
		...
		juani	 : [ 'format','undoredo', 'style', 'alignment', 'colors']
